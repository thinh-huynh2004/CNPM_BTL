import './printer_changeInfo.css'
import './printer_add.css'

function PrinterChangeInfo({onAdd, onCancel}) {
    return (
        <div className='changeInfo_fullScreen'>
            <div className="changeInfo_midBox">
                <h6 className="changeInfo_title">
                    Chinh sua thong tin may in
                </h6>
                <div className="changeInfo_midBox_line"></div>
...
export default PrinterChangeInfo